...
mixin _$PlayerModel {
  ...
  String? get ava => throw _privateConstructorUsedError;
...
abstract class $PlayerModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? displayName, String? ava, String id});
}
...
class _$PlayerModelCopyWithImpl<$Res, $Val extends PlayerModel>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      ava: freezed == ava
          ? _value.ava
          : ava // ignore: cast_nullable_to_non_nullable
              as String?,
      id: null == id
          ? _value.id
...
class _$PlayerModelImpl implements _PlayerModel {
  const _$PlayerModelImpl(
      {required this.displayName, required this.ava, required this.id});
  ...
  @override
  String toString() {
    return 'PlayerModel(displayName: $displayName, ava: $ava, id: $id)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.ava, ava) || other.ava == ava) &&
            (identical(other.id, id) || other.id == id));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, displayName, ava, id);
